  ...
  <metadata>
    ...
    <packageTypes>
      ...
      <packageType name=""bar"" />
            ...
            Assert.Equal("foo", manifest.Metadata.PackageTypes[0].Name);
            Assert.Equal(new Version(2, 0, 0), manifest.Metadata.PackageTypes[0].Version);
            Assert.Equal("bar", manifest.Metadata.PackageTypes[1].Name);
            Assert.Equal(new Version(0, 0), manifest.Metadata.PackageTypes[1].Version);
        }
