...
using Proxy.EnvDTE;
using Proxy.Microsoft.VisualStudio;
using Proxy.Microsoft.VisualStudio.Shell.Interop;
using Proxy.Microsoft.VisualStudio.ProjectSystem;
using Proxy.Microsoft.VisualStudio.ProjectSystem.Designers;
using MsBuildProject = Proxy.Microsoft.Build.Evaluation.ProxyProject;
