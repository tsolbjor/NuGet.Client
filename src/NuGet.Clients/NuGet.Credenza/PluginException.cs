    ...
    public class PluginException : Exception
    {
        ...
        public static PluginException Create(string path, Exception inner)
        {
            return new PluginException(
                string.Format(CredentialResources.PluginException_Exception_Format, path, inner.GetType().Name),
                inner);
        }
        ...
        {
            return new PluginException(
                string.Format(CredentialResources.PluginException_Timeout_Format, path, timeoutMillis));
        }
            ...
            string path, int exitCode, string stdout, string stderr)
        {
            ...
            {
                 string.Format(CredentialResources.PluginException_Error_Format, path, exitCode),
                 stdout,
                 stderr
        ...
        {
            return new PluginException(string.Format(CredentialResources.PluginException_NotStarted_Format, path));
        }

        public static PluginException CreatePathNotFoundMessage(string path, string attempted)
        {
            return new PluginException(string.Format(CredentialResources.PluginException_PathNotFound_Format, path,
                attempted));
        }

        public static PluginException CreateAbortMessage(string path, string message)
        {
            return new PluginException(string.Format(CredentialResources.PluginException_Abort_Format, path, message));
        }
            ...
            string payload)
        {
            return new PluginException(string.Format(
                CredentialResources.PluginException_IncorrectPayload_Format,
                path,
                status,
                payload));
        }
