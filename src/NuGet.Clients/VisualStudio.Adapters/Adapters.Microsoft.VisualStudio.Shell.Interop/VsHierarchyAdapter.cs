...
namespace Adapters.Microsoft.VisualStudio.Shell.Interop
{
    ...
    public class VsHierarchyAdapter : VsAdapterBase, IVsHierarchy
    {
        internal VsHierarchyAdapter() { }

        public VsHierarchyAdapter(global::Microsoft.VisualStudio.Shell.Interop.IVsHierarchy vsHierarchy)
            : base(vsHierarchy)
        {
        }
