...
namespace NuGet.VisualStudio.Adapters
{
    public static class Utility
    {
        ...
        public static Task<T> TaskCast<T>(Func<Task<global::Microsoft.VisualStudio.ProjectSystem.ConfiguredProject>> taskFunction) where T : VsAdapterBase, new()
        {
        ...
        public static Task<T> TaskCast<T>(Func<Task<global::Microsoft.Build.Evaluation.Project>> taskFunction) where T : VsAdapterBase, new()
        {
            var tcs = new TaskCompletionSource<T>();
            taskFunction().ContinueWith(t =>
            {
