...
namespace Adapters.Microsoft.VisualStudio.ProjectSystem.Designers
{
    ...
    public class VsBrowseObjectContextAdapter : VsAdapterBase, IVsBrowseObjectContext
    {
        internal VsBrowseObjectContextAdapter() { }

        public VsBrowseObjectContextAdapter(global::Microsoft.VisualStudio.ProjectSystem.Designers.IVsBrowseObjectContext vsBrowseObjectContext) :
        ...
        public UnconfiguredProject UnconfiguredProject
        {
            get
            {
                return new UnconfiguredProjectAdapter(Instance.UnconfiguredProject);
            }
        }
        #endregion
    }
