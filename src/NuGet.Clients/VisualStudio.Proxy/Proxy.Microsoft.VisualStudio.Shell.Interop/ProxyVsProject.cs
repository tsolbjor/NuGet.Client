...
namespace Proxy.Microsoft.VisualStudio.Shell.Interop
{
    ...
    public class ProxyVsProject : VsProxy, IVsProject
    {
        internal ProxyVsProject() { }

        public ProxyVsProject(global::Microsoft.VisualStudio.Shell.Interop.IVsProject vsProject)
            : base(vsProject)
        { }
