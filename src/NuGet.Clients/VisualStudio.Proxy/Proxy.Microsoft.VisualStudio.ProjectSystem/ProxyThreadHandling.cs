...
namespace Proxy.Microsoft.VisualStudio.ProjectSystem
{
    ...
    public class ProxyThreadHandling : VsProxy, IThreadHandling
    {
        internal ProxyThreadHandling() { }

        public ProxyThreadHandling(global::Microsoft.VisualStudio.ProjectSystem.IThreadHandling threadHandling) :
            base(threadHandling)
        {
        }
