...
namespace Proxy.Microsoft.VisualStudio.ProjectSystem
{
    ...
    public struct ProjectWriteLockReleaser : IDisposable
    {
        ...
        public Task<Proxy.Microsoft.Build.Evaluation.ProxyProject> GetProjectAsync(ConfiguredProject configuredProject)
        {
            global::Microsoft.VisualStudio.ProjectSystem.ProjectWriteLockReleaser instance = _instance;
            return NuGet.VisualStudio.Proxy.Utility.TaskCast<Proxy.Microsoft.Build.Evaluation.ProxyProject>(
    ...
    public class ProxyProjectLockService : VsProxy, IProjectLockService
    {
